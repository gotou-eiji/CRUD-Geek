...
namespace Geek
{
    public partial class FrmVenda : Form
    {
        ...
        private void btnPedido_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Insira um novo pedido!", "Erro", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        ...
        private void btnAtualizarPedido_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Selecione um cadastro correto para ser atualizado!", "Erro", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        ...
        private void btnNovoItem_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Preencha o cadastro para ser inserido!", "Produto repetido", MessageBoxButtons.OK, MessageBoxIcon.Warning);
            }
        }

        private void dgvVenda_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            if (dgvVenda.Rows[0].Cells[1].Value != null)
            {
                try
                {
                ...
                {
                    MessageBox.Show(er.Message, "Selecione um pedido preenchido!", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    this.txtIdPedido.Focus();
                }
            }
            else
            {
                MessageBox.Show("Selecione um pedido preenchido!", "Erro", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        ...
        private void btnEditar_Click(object sender, EventArgs e)
        {
            if (dgvVenda.Rows[0].Cells[1].Value != null)
            {
                ...
                {
                    MessageBox.Show("Selecione um pedido correto para ser editado!", "Erro", MessageBoxButtons.OK, MessageBoxIcon.Error);
                }
            }
            else
            {
        ...
        private void btnExcluir_Click(object sender, EventArgs e)
        {
            if (dgvVenda.Rows[0].Cells[1].Value != null)
            {
                ...
                {
                    MessageBox.Show("Selecione um pedido correto para ser deletado!", "Erro", MessageBoxButtons.OK, MessageBoxIcon.Information);
                }
            }
            else
            {
        ...
        private void btnFinalizarPedido_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Selecione um pedido para ser realizado!", "Erro", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        ...
        private void btnFinalizarVenda_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Selecione um cadastro completo para finalizar!", "Erro", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
